...
pub use monitor::{
    clear_last_content_cache, is_monitor_running, pause_clipboard_monitor_for,
    set_last_hash_contents, set_last_hash_file, set_last_hash_files, set_last_hash_text,
