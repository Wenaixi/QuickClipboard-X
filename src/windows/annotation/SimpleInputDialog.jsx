...
// 图像编辑器文本标注输入浮层:替换 window.prompt——WebView2 对 prompt
// 支持有别于常规浏览器(可能直接返回 null 让文本工具静默失效),且原生
// prompt 样式与编辑器主题割裂。自绘浮层与主窗口 SimpleInputDialog 同款
// 交互:Enter 确认/Esc 取消/点遮罩取消/autoFocus 直接输入。
