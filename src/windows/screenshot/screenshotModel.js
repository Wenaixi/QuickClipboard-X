...
export function normalizeBootstrap(payload = {}, viewport = {}) {
  ...
  return {
    ...
    screenshotElementDetection: payload.screenshotElementDetection === 'none' || payload.screenshotElementDetection === 'window' ? payload.screenshotElementDetection : 'all',
    screenshotColorIncludeFormat: payload.screenshotColorIncludeFormat !== false,
