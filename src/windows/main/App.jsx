...
function App() {
  ...
  const ContentComponent = <div ref={contentDragRef} className="main-content-area flex-1 min-h-0 overflow-hidden relative pb-[8px] bg-qc-surface transition-colors duration-500">
      ...
      {activeTab === 'emoji' && <Suspense fallback={null}><EmojiTab ref={emojiTabRef} emojiMode={emojiMode} onEmojiModeChange={setEmojiMode} onSwitchTab={handleEmojiSwitchTab} searchQuery={searchQuery} /></Suspense>}
    </div>;
